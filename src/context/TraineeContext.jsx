...
export const TraineeProvider=({children})=> {
  ...
  const [courseCategories,setCourseCategories]=useState([
    'General','Programming','Web Development','Mobile Development','Design','UI/UX','Marketing','Digital Marketing','Management','Leadership','Technical Skills','Soft Skills','Communication','Language','Certification','Security','Data Science','AI/ML'
  ]);
  ...
  const [instructorCourses,setInstructorCourses]=useState([
    'Unity','Blender','Maya','Photoshop','Illustrator','After Effects','React','Vue.js','Angular','Node.js','Python','Java','C#','JavaScript','TypeScript'
  ]);
  ...
  const updateInstructor=(id,updates)=> {
    setInstructors(prev=> 
      prev.map(instructor=> 
        instructor.id===id 
          ? {...instructor,...updates,updatedAt: new Date().toISOString()} 
          : instructor
      )
    );
  };
