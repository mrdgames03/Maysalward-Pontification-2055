...
const {FiArrowLeft,FiFlag,FiStar,FiActivity,FiCalendar,FiUser,FiMail,FiPhone,FiBook,FiPlus,FiAward,FiTrash,FiTrendingUp}=FiIcons;

const TraineeDetails=()=> {
  const {id}=useParams();
  const navigate=useNavigate();
  const {getTraineeById,getTraineeCheckIns,flagTrainee,deleteTrainee,updateTrainee,addTrainingSession,getTraineeTrainingSessions,markSessionComplete,updateTrainingSession,deleteTrainingSession,addCourse,getTraineeCourses,markCourseComplete,updateCourse,deleteCourse}=useTrainee();
