...
const { FiSearch, FiFilter, FiUser, FiStar, FiFlag, FiEye, FiCalendar, FiMail, FiTrash, FiCheck, FiX, FiUsers } = FiIcons;

const TraineeList = () => {
  const { trainees, flagTrainee, deleteTrainee } = useTrainee();
