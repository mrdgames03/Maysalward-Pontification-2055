...
const { FiX, FiTrash, FiAlertTriangle, FiLock, FiEye, FiEyeOff } = FiIcons;

const DeleteTraineeModal = ({ isOpen, onClose, trainee, onConfirmDelete }) => {
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">Delete Trainee</h2>
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center">
              <SafeIcon icon={FiTrash} className="text-red-600" />
            </div>
            <div>
              <h3 className="font-semibold text-red-900">{trainee.name}</h3>
              <p className="text-red-700 text-sm">{trainee.serialNumber}</p>
              <p className="text-red-600 text-sm">{trainee.email}</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start space-x-2">
            ...
            <div className="text-sm text-yellow-800">
              ...
              <ul className="list-disc list-inside space-y-1 text-yellow-700">
                <li>Trainee profile and personal information</li>
                <li>All check-in records and activity history</li>
                <li>Course enrollments and training sessions</li>
          ...
          <div className="flex items-start space-x-2">
            ...
            <div className="text-xs text-gray-600">
              ...
              <p>
                ...
                personnel can delete trainee records.
              </p>
            </div>
          </div>
        </div>
